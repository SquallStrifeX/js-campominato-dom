...
1- Generiamo 16 numeri casuali in base al livello di difficoltà
2- mettiamo questi 16 numeri in un array e facciamo in modo che non ci siano duplicati
3- facciamo in modo che cliccando sulla cella, la cella diventi rossa se trova un numero dell'array oppure di azzurra se non
4- facciamo terminare la partita se il giocatore trova una bomba
5- mostriamo a schermo il punteggio totale ottenuto
